...
fn default_named_color(name: NamedColor) -> Rgb {
    match name {
        ...
        NamedColor::Foreground | NamedColor::BrightForeground | NamedColor::DimForeground => Rgb {
            r: 204,
            g: 204,
            b: 204,
        },
