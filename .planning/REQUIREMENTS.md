...
- [x] **MCP-05**: `glass_agent_lock` tool atomically claims advisory file locks
- [x] **MCP-06**: `glass_agent_unlock` tool releases file locks
- [x] **MCP-07**: `glass_agent_locks` tool lists all active locks across agents
- [x] **MCP-08**: `glass_agent_broadcast` tool sends typed message to all project agents
- [x] **MCP-09**: `glass_agent_send` tool sends directed message to specific agent
- [x] **MCP-10**: `glass_agent_messages` tool reads unread messages
...
| MCP-05 | Phase 32 | Complete |
| MCP-06 | Phase 32 | Complete |
| MCP-07 | Phase 32 | Complete |
| MCP-08 | Phase 32 | Complete |
| MCP-09 | Phase 32 | Complete |
